                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                <h3 class="font-semibold text-gray-900">{{ $user->name }}</h3>
                                                <p class="text-sm text-gray-600">
                                                    {{ $user->getYearsOfService() }}
                                                    {{ Str::plural('year', $user->getYearsOfService()) }} of service!
                                                </p>
                                                <p class="text-xs text-gray-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Optional - only the month and day will be shown to
                                        others</p>
                                </div>

                                <div>
                                    <label for="birthday_visibility" class="block text-sm font-medium text-gray-700">Who can
                                        see your birthday?</label>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="hire_date" id="hire_date"
                                        ...
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <p class="mt-1 text-xs text-gray-500">Optional - your start date with the organization
                                    </p>
                                </div>

                                <div class="flex items-center">
                                    <input type="checkbox" name="show_work_anniversary" id="show_work_anniversary"
                                        value="1" {{ auth()->user()->show_work_anniversary ? 'checked' : '' }}
