                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="code" name="code"
                                    value="{{ old('code', $station->code) }}" required maxlength="10"
                                ...
                                <select id="centre_id" name="centre_id" required
                                    ...
                                    @foreach ($centres as $centre)
                                        <option value="{{ $centre->id }}"
                                            {{ old('centre_id', $station->centre_id) == $centre->id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <input type="text" id="location" name="location"
                                    value="{{ old('location', $station->location) }}" required
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="3"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('description') border-red-300 @enderror">{{ old('description', $station->description) }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="contact_person" name="contact_person"
                                        value="{{ old('contact_person', $station->contact_person) }}"
                                ...
                                <div>
                                    ...
                                    <input type="email" id="contact_email" name="contact_email"
                                        value="{{ old('contact_email', $station->contact_email) }}"
                            ...
                            <div>
                                ...
                                <input type="text" id="contact_phone" name="contact_phone"
                                    value="{{ old('contact_phone', $station->contact_phone) }}"
