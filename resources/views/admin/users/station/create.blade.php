...
@section('page-title')
    <div>
        <h1 class="text-2xl font-semibold text-gray-900">Add Station Staff</h1>
        <p class="text-sm text-gray-500 mt-1">Create staff accounts for your station.</p>
    </div>
@endsection
...
@section('content')
    <div class="max-w-2xl">
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm px-6 py-6">
            <form method="POST" action="{{ route('admin.station.users.store') }}" class="space-y-5">
                @csrf
                ...
                <p class="text-xs text-gray-500">Staff will automatically inherit your centre and station.</p>
                ...
                <div class="flex items-center justify-end space-x-3">
                    ...
                    <button type="submit"
                        class="px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white text-sm font-medium rounded-lg shadow">Save</button>
                </div>
            </form>
        </div>
    </div>
