...
@section('title', 'Edit Station Staff')

@section('page-title')
    <div>
        <h1 class="text-2xl font-semibold text-gray-900">Edit Station Staff</h1>
...
@section('content')
    <div class="max-w-2xl">
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm px-6 py-6">
            <form method="POST" action="{{ route('admin.station.users.update', $user) }}" class="space-y-5">
                @csrf
                @method('PATCH')
                ...
                <p class="text-xs text-gray-500">Staff automatically remain assigned to your station.</p>
                ...
                <div class="flex items-center justify-end space-x-3">
                    ...
                    <button type="submit"
                        class="px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white text-sm font-medium rounded-lg shadow">Save
                        changes</button>
                </div>
            </form>
        </div>
