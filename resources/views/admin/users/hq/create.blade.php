    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-3 mb-2">
                <a href="{{ route('admin.hq.users.index') }}" class="p-2 hover:bg-gray-100 rounded-lg transition-colors">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Create a new staff account for Headquarters</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            {{-- Form --}}
            <form method="POST" action="{{ route('admin.hq.users.store') }}" class="p-6 space-y-6">
                @csrf
