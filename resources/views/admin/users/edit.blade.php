...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit User Role</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Manage {{ $user->name }}'s role and organizational
                    assignment</p>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <div x-show="selectedRole === 'super_admin'" class="text-sm text-gray-600 dark:text-gray-400">
                                <strong>Super Administrator:</strong> Full system access, can manage all users and settings
                                across the entire NIMR organization.
                            </div>
                            <div x-show="selectedRole === 'hq_admin'" class="text-sm text-gray-600 dark:text-gray-400">
                                <strong>HQ Administrator:</strong> Manages headquarters operations and can oversee all
                                centres and stations.
                            </div>
                            <div x-show="selectedRole === 'centre_admin'" class="text-sm text-gray-600 dark:text-gray-400">
                                <strong>Centre Administrator:</strong> Manages a specific research centre and its associated
                                stations.
                            </div>
                            <div x-show="selectedRole === 'station_admin'" class="text-sm text-gray-600 dark:text-gray-400">
                                <strong>Station Administrator:</strong> Manages a specific research station within a centre.
                            </div>
                            <div x-show="selectedRole === 'staff'" class="text-sm text-gray-600 dark:text-gray-400">
                                <strong>Staff Member:</strong> Regular user with access to relevant announcements and
                                resources.
                            </div>
                        </div>
                    </div>

                    <!-- Centre Selection (for centre_admin, station_admin, and staff) -->
                    <div x-show="['centre_admin', 'station_admin', 'staff'].includes(selectedRole)" x-transition>
                        <label for="centre_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Research Centre
                    ...
                    <!-- Station Selection (for station_admin and optionally staff) -->
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
                        <h4 class="text-sm font-medium text-blue-900 dark:text-blue-100 mb-2">Current Assignment</h4>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div class="text-2xl font-bold text-gray-900 dark:text-white">{{ $user->created_at->diffForHumans() }}
                    </div>
                ...
                <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div class="text-sm text-gray-600 dark:text-gray-400">Current Role</div>
                </div>
            </div>
        </div>
    </div>
