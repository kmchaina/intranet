        ...
        <div class="mb-6">
            <div class="flex items-center gap-3 mb-2">
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Update user information, role, and assignments</p>
                </div>
            </div>
        </div>

        {{-- Form Card --}}
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" x-data="userEditForm()">
            {{-- Card Header --}}
        ...
        <script>
            function userEditForm() {
                return {
                    ...
                    centreId: '{{ old('centre_id', $user->centre_id) }}',
                }
            }
        </script>
    @endpush
