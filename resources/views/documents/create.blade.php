    ...
    <div class="p-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-2">Share a new document with the organization</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-8">
                <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <!-- File Upload -->
                    <div>
                        <label for="file" class="block text-sm font-semibold text-gray-900 dark:text-white mb-3">
                        ...
                        <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center hover:border-blue-400 dark:hover:border-blue-500 transition-colors"
                            ...
                            <div class="text-gray-500 dark:text-gray-400" id="file-drop-content">
                            ...
                            <div id="file-selected" class="hidden">
                                <div class="flex items-center justify-center space-x-3">
                                    ...
                                    <span id="file-name" class="text-gray-900 dark:text-white font-medium"></span>
                                </div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 resize-vertical"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="category" name="category"
                                ...
                                <option value="research" {{ old('category') === 'research' ? 'selected' : '' }}>Research
                                </option>
                                <option value="administrative"
                                    {{ old('category') === 'administrative' ? 'selected' : '' }}>Administrative</option>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Tags -->
                        <div>
                            <label for="tags" class="block text-sm font-semibold text-gray-900 dark:text-white mb-3">
                                Tags
                            </label>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Optional Settings</h3>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" id="expires_at" name="expires_at"
                                    ...
                                    class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-white">
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Leave empty for permanent document
                                </p>
                                @error('expires_at')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="flex items-center">
                                ...
                                <label for="requires_download_permission"
