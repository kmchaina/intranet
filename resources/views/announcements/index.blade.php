                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 mt-1">Stay updated with the latest news from NIMR</p>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center gap-4">
                        ...
                        <div class="flex-1">
                            <div class="relative">
                                ...
                                <input type="text" id="searchInput" placeholder="Search announcements..."
                                    class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-gray-800 placeholder-gray-500">
                            </div>
                        </div>
                        ...
                        <div class="lg:w-48">
                            <select id="categoryFilter"
                                class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-gray-800">
            ...
            <div class="bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-100">
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm text-gray-600">{{ $announcements->total() }} announcement(s) found</span>
                    </div>
                </div>
                                            ...
                                            @foreach ($announcement->attachments->take(3) as $attachment)
                                                <div
                                                    ...
                                                    <svg class="w-3 h-3" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2" d="{{ $attachment->getFileIcon() }}" />
                                                    </svg>
                                                    <span
