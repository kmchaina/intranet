                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-2">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            <a href="{{ route('documents.show', $document) }}" class="hover:text-blue-600 dark:hover:text-blue-400">
                                {{ $document->title }}
                            </a>
                        </h3>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                            @if($document->access_level === 'public') bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200
                            @elseif($document->access_level === 'restricted') bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200
