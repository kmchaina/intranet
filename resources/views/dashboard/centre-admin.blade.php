...
@section('page-title')
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-medium bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 bg-clip-text text-transparent tracking-tight">
                Centre Administration
            </h1>
            <p class="text-gray-600 mt-1">{{ $userRole }} - {{ auth()->user()->location->name ?? 'Centre Management' }}</p>
        </div>
...
@section('content')
            ...
            <div class="relative p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ $adminStats['centreAnnouncements'] ?? 0 }}</p>
                        <div class="flex items-center mt-2">
                            <div class="w-2 h-2 bg-green-400 rounded-full mr-2"></div>
                            <span class="text-xs text-gray-600">Centre-wide</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 px-6 py-3 border-t border-gray-100">
                <a href="{{ route('announcements.index') }}" class="flex items-center justify-between text-sm font-medium text-gray-700 hover:text-green-600 group transition-colors">
            ...
            <div class="relative p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ $adminStats['centreDocuments'] ?? 0 }}</p>
                        <div class="flex items-center mt-2">
                            <div class="w-2 h-2 bg-blue-400 rounded-full mr-2"></div>
                            <span class="text-xs text-gray-600">Centre documents</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="group relative bg-white overflow-hidden rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
            <div class="relative p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        <p class="text-sm font-medium text-gray-600 uppercase tracking-wider">📍 Stations</p>
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ $adminStats['centreStations'] ?? 0 }}</p>
                        <div class="flex items-center mt-2">
                            <div class="w-2 h-2 bg-purple-400 rounded-full mr-2"></div>
                            <span class="text-xs text-gray-600">Under this centre</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 px-6 py-3 border-t border-gray-100">
                <a href="{{ route('admin.stations.index') }}" class="flex items-center justify-between text-sm font-medium text-gray-700 hover:text-purple-600 group transition-colors">
    ...
    <div class="mb-8">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                <a href="{{ route('announcements.create') }}" class="flex flex-col items-center p-4 rounded-lg border border-gray-200 hover:border-green-300 hover:bg-green-50 transition-colors group">
                    ...
                    <span class="text-sm font-medium text-gray-700 group-hover:text-green-700">Create Announcement</span>
                </a>
                ...
                <a href="{{ route('admin.centre.staff.index') }}" class="flex flex-col items-center p-4 rounded-lg border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 transition-colors group">
                    ...
                    <span class="text-sm font-medium text-gray-700 group-hover:text-indigo-700">Manage Staff</span>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    <h2 class="text-lg font-semibold text-gray-900">📊 Centre Overview</h2>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <div class="text-center">
                            <div class="text-2xl font-bold text-purple-600">{{ $adminStats['centreStations'] ?? 0 }}</div>
                            <div class="text-sm text-gray-600">Stations</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-blue-600">{{ $adminStats['centreUsers'] ?? 0 }}</div>
                            <div class="text-sm text-gray-600">Users</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-green-600">{{ $adminStats['centreAnnouncements'] ?? 0 }}</div>
                            <div class="text-sm text-gray-600">Announcements</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-yellow-600">{{ $adminStats['centreDocuments'] ?? 0 }}</div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 mt-6">
                <div class="p-6 border-b border-gray-100">
                    <h3 class="text-lg font-semibold text-gray-900">📈 Recent Centre Activity</h3>
                </div>
                <div class="p-6">
        ...
        <!-- Centre Admin Sidebar -->
        <div class="space-y-6">
            <!-- Station Performance -->
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    <h3 class="text-lg font-semibold text-gray-900">📍 Station Status</h3>
                </div>
                <div class="p-6">
                    <div class="space-y-4">
                            ...
                            @foreach($stationStats as $station)
                                <div class="flex items-center justify-between p-3 rounded-lg border border-gray-100">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">{{ $station['location'] ?? 'Research Station' }}</p>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-sm font-medium text-gray-900">{{ $station['users_count'] ?? 0 }} users</div>
                                        <div class="text-xs text-gray-500">{{ $station['recent_activity'] ?? 0 }} recent</div>
                                    </div>
                                </div>
                            @endforeach
                        @else
                            <div class="text-center py-4">
                                ...
                                <p class="text-sm text-gray-500">No stations configured</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    <h3 class="text-lg font-semibold text-gray-900">🔗 Centre Management</h3>
                </div>
                <div class="p-6">
                    <div class="space-y-3">
                        <a href="{{ route('admin.reports.centre') }}" class="flex items-center p-3 rounded-lg border border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-colors group">
                            <div class="flex-1">
                                <h4 class="font-medium text-gray-900 group-hover:text-green-600">Centre Reports</h4>
                                <p class="text-sm text-gray-600 mt-1">View centre analytics</p>
                            </div>
                        ...
                        <a href="{{ route('admin.centre.staff.index') }}" class="flex items-center p-3 rounded-lg border border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-colors group">
                            <div class="flex-1">
                                <h4 class="font-medium text-gray-900 group-hover:text-green-600">Staff Management</h4>
                                <p class="text-sm text-gray-600 mt-1">Manage centre staff</p>
                            </div>
                            <svg class="w-4 h-4 text-gray-400 group-hover:text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                        ...
                        <a href="{{ route('admin.centre.projects.index') }}" class="flex items-center p-3 rounded-lg border border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-colors group">
                            <div class="flex-1">
                                <h4 class="font-medium text-gray-900 group-hover:text-green-600">Research Projects</h4>
                                <p class="text-sm text-gray-600 mt-1">Manage centre projects</p>
                            </div>
                            <svg class="w-4 h-4 text-gray-400 group-hover:text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
