...
<div class="flex items-center justify-between">
    <div>
        <h1 class="text-3xl font-bold bg-gradient-to-r from-orange-600 via-amber-600 to-yellow-600 bg-clip-text text-transparent tracking-tight">
            Station Command Hub
        </h1>
        <p class="text-gray-600 mt-2 text-lg">{{ auth()->user()->location->name ?? 'Station Management' }} - Executive Dashboard</p>
        <div class="flex items-center mt-3 space-x-4">
            <div class="flex items-center space-x-2">
                <div class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                <span class="text-sm text-gray-600">Station Active</span>
            </div>
    ...
    <div class="text-right">
        <div class="bg-gradient-to-r from-orange-500 to-amber-600 text-white px-6 py-3 rounded-xl shadow-lg">
            <div class="text-sm font-medium opacity-90">Welcome back,</div>
