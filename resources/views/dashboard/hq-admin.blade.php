...
@section('page-title')
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-medium bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent tracking-tight">
                Headquarters Administration
            </h1>
            <p class="text-gray-600 mt-1">{{ $userRole }} - Organization-wide Management</p>
        </div>
...
@section('content')
            ...
            <div class="relative p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ $adminStats['totalAnnouncements'] ?? 0 }}</p>
                        <div class="flex items-center mt-2">
                            <div class="w-2 h-2 bg-blue-400 rounded-full mr-2"></div>
                            <span class="text-xs text-gray-600">Organization-wide</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 px-6 py-3 border-t border-gray-100">
                <a href="{{ route('announcements.index') }}" class="flex items-center justify-between text-sm font-medium text-gray-700 hover:text-blue-600 group transition-colors">
            ...
            <div class="relative p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ $adminStats['totalDocuments'] ?? 0 }}</p>
                        <div class="flex items-center mt-2">
                            <div class="w-2 h-2 bg-green-400 rounded-full mr-2"></div>
                            <span class="text-xs text-gray-600">Organizational docs</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 px-6 py-3 border-t border-gray-100">
                <a href="{{ route('documents.index') }}" class="flex items-center justify-between text-sm font-medium text-gray-700 hover:text-green-600 group transition-colors">
        ...
        <div class="group relative bg-white overflow-hidden rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
            <div class="relative p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        <p class="text-sm font-medium text-gray-600 uppercase tracking-wider">🏢 Centres</p>
                        <p class="text-2xl font-bold text-gray-900 mt-1">{{ $adminStats['totalCentres'] ?? 0 }}</p>
                        <div class="flex items-center mt-2">
                            <div class="w-2 h-2 bg-purple-400 rounded-full mr-2"></div>
                            <span class="text-xs text-gray-600">Under HQ oversight</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 px-6 py-3 border-t border-gray-100">
                <a href="{{ route('admin.centres.index') }}" class="flex items-center justify-between text-sm font-medium text-gray-700 hover:text-purple-600 group transition-colors">
    ...
    <div class="mb-8">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                <a href="{{ route('announcements.create') }}" class="flex flex-col items-center p-4 rounded-lg border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-colors group">
                    ...
                    <span class="text-sm font-medium text-gray-700 group-hover:text-blue-700">Create Announcement</span>
                </a>

                <a href="{{ route('documents.create') }}" class="flex flex-col items-center p-4 rounded-lg border border-gray-200 hover:border-green-300 hover:bg-green-50 transition-colors group">
                    ...
                    <span class="text-sm font-medium text-gray-700 group-hover:text-green-700">Upload Document</span>
                </a>
                ...
                <a href="{{ route('admin.reports.organizational') }}" class="flex flex-col items-center p-4 rounded-lg border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 transition-colors group">
                    <div class="w-8 h-8 bg-indigo-100 rounded-lg flex items-center justify-center group-hover:bg-indigo-200 transition-colors mb-2">
                        <svg class="w-4 h-4 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                        </svg>
                    </div>
                    <span class="text-sm font-medium text-gray-700 group-hover:text-indigo-700">View Reports</span>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    <h2 class="text-lg font-semibold text-gray-900">📊 Headquarters Overview</h2>
                </div>
                <div class="p-6">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <div class="text-center">
                            <div class="text-2xl font-bold text-blue-600">{{ $adminStats['totalCentres'] ?? 0 }}</div>
                            <div class="text-sm text-gray-600">Centres</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-green-600">{{ $adminStats['totalStations'] ?? 0 }}</div>
                            <div class="text-sm text-gray-600">Stations</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-purple-600">{{ $adminStats['totalAnnouncements'] ?? 0 }}</div>
                            <div class="text-sm text-gray-600">Announcements</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-yellow-600">{{ $adminStats['totalDocuments'] ?? 0 }}</div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 mt-6">
                <div class="p-6 border-b border-gray-100">
                    <h3 class="text-lg font-semibold text-gray-900">📈 Recent Organizational Activity</h3>
                </div>
                <div class="p-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    <h3 class="text-lg font-semibold text-gray-900">🏢 Centre Status</h3>
                </div>
                <div class="p-6">
                    <div class="space-y-4">
                        @if($centreStats ?? false)
                            @foreach($centreStats as $centre)
                                <div class="flex items-center justify-between p-3 rounded-lg border border-gray-100">
                                    <div>
                                        <h4 class="font-medium text-gray-900">{{ $centre['name'] }}</h4>
                                        <p class="text-sm text-gray-600">{{ $centre['stations_count'] }} stations</p>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-sm font-medium text-gray-900">{{ $centre['users_count'] }} users</div>
                                        <div class="text-xs text-gray-500">{{ $centre['recent_activity'] ?? 0 }} recent</div>
                                    </div>
                                </div>
                            @endforeach
                        @else
                            <div class="text-center py-4">
                                ...
                                <p class="text-sm text-gray-500">No centres configured</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    <h3 class="text-lg font-semibold text-gray-900">🔗 HQ Management</h3>
                </div>
                <div class="p-6">
                    <div class="space-y-3">
                        <a href="{{ route('admin.reports.organizational') }}" class="flex items-center p-3 rounded-lg border border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-colors group">
                            <div class="flex-1">
                                <h4 class="font-medium text-gray-900 group-hover:text-blue-600">Organizational Reports</h4>
                                <p class="text-sm text-gray-600 mt-1">View cross-centre analytics</p>
                            </div>
                        ...
                        <a href="{{ route('admin.policies.index') }}" class="flex items-center p-3 rounded-lg border border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-colors group">
                            <div class="flex-1">
                                <h4 class="font-medium text-gray-900 group-hover:text-blue-600">Policy Management</h4>
                                <p class="text-sm text-gray-600 mt-1">Organizational policies</p>
                            </div>
                            <svg class="w-4 h-4 text-gray-400 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                        ...
                        <a href="{{ route('admin.training.index') }}" class="flex items-center p-3 rounded-lg border border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-colors group">
                            <div class="flex-1">
                                <h4 class="font-medium text-gray-900 group-hover:text-blue-600">Training Programs</h4>
                                <p class="text-sm text-gray-600 mt-1">Staff development</p>
                            </div>
                            <svg class="w-4 h-4 text-gray-400 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
