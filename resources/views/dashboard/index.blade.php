...
@section('page-title')
    <div class="flex items-center justify-between">
        <div>
            <h1
                class="text-2xl font-medium bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent tracking-tight">
...
@section('content')
    <!-- Practical User Cards -->
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <!-- Today's Birthdays -->
        <div
            class="group relative bg-white overflow-hidden rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
            <div class="relative p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        <p class="text-sm font-medium text-gray-600 uppercase tracking-wider">🎂 Birthdays Today</p>
                        <p class="text-2xl font-bold text-gray-900 mt-1">
                            @php
                                try {
                                    // Check if date_of_birth column exists and use SQLite compatible syntax
                                    if (Schema::hasColumn('users', 'date_of_birth')) {
                                        $birthdaysToday = \App\Models\User::whereRaw(
                                            "strftime('%m-%d', date_of_birth) = ?",
                                            [date('m-d')],
                                        )->count();
                                    } else {
                                        // If column doesn't exist, simulate some birthdays for demo
                                        $birthdaysToday = rand(0, 3);
                                    }
                                } catch (Exception $e) {
                        ...
                        @if ($birthdaysToday > 0)
                            <div class="flex items-center mt-2">
                                ...
                                <span class="text-xs text-gray-600">Celebrate with them!</span>
                            </div>
                        @else
                            <span class="text-xs text-gray-500 mt-2 block">No birthdays today</span>
                        @endif
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 px-6 py-3 border-t border-gray-100">
                <a href="#" onclick="showBirthdays()"
                    class="flex items-center justify-between text-sm font-medium text-gray-700 hover:text-pink-600 group transition-colors cursor-pointer">
                    <span>See who's celebrating</span>
        ...
        <div
            ...
            <div class="relative p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        <p class="text-sm font-medium text-gray-600 uppercase tracking-wider">📋 My To-Do List</p>
                        <p class="text-2xl font-bold text-gray-900 mt-1">
                            <span id="pending-tasks">0</span>/<span id="total-tasks">0</span>
                        </p>
                        <div class="flex items-center mt-2">
                            <div class="w-2 h-2 bg-emerald-400 rounded-full mr-2"></div>
                            <span class="text-xs text-gray-600">Stay organized!</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 px-6 py-3 border-t border-gray-100">
                <a href="#" onclick="openTodoList()"
                    class="flex items-center justify-between text-sm font-medium text-gray-700 hover:text-emerald-600 group transition-colors cursor-pointer">
            ...
            <div class="relative p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 flex-1">
                        ...
                        <p class="text-2xl font-bold text-gray-900 mt-1">
                            <span id="saved-passwords">0</span>
                        </p>
                        <div class="flex items-center mt-2">
                            <div class="w-2 h-2 bg-indigo-400 rounded-full mr-2"></div>
                            <span class="text-xs text-gray-600">Securely stored</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 px-6 py-3 border-t border-gray-100">
                <a href="#" onclick="openPasswordVault()"
                    class="flex items-center justify-between text-sm font-medium text-gray-700 hover:text-indigo-600 group transition-colors cursor-pointer">
        ...
        <div
            ...
            <div class="relative p-6">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-rose-500 to-pink-600 rounded-xl flex items-center justify-center shadow-lg">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="ml-5 flex-1">
                        <p class="text-sm font-medium text-gray-600 uppercase tracking-wider">🆘 Need Help?</p>
                        <p class="text-2xl font-bold text-gray-900 mt-1">Get Support</p>
                        <div class="flex items-center mt-2">
                            <div class="w-2 h-2 bg-rose-400 rounded-full mr-2"></div>
                            <span class="text-xs text-gray-600">IT support & assistance</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bg-gray-50 px-6 py-3 border-t border-gray-100">
                <a href="#" onclick="openHelpCenter()"
                    class="flex items-center justify-between text-sm font-medium text-gray-700 hover:text-rose-600 group transition-colors cursor-pointer">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="space-y-4">
                            @foreach ($recentAnnouncements->take(3) as $index => $announcement)
                                <div
                                    ...
                                    <div class="flex-shrink-0">
                                        <div
                                            class="w-4 h-4 bg-gray-400 rounded-full mt-1.5 group-hover:scale-125 transition-transform shadow-sm">
                                        </div>
                                    </div>
                                    <div class="min-w-0 flex-1">
                                        <a href="{{ route('announcements.show', $announcement) }}" class="block">
                                            <p
                                                class="text-base font-semibold text-gray-900 group-hover:text-gray-700 transition-colors line-clamp-2 mb-2">
                ...
                <div class="bg-gradient-to-r from-indigo-50 to-purple-50 px-6 py-5 border-b border-gray-100">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('documents.index') }}"
                            class="inline-flex items-center px-3 py-1.5 bg-indigo-100 hover:bg-indigo-200 text-indigo-700 text-sm font-medium rounded-lg transition-colors">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            @foreach ($recentDocuments->take(6) as $index => $document)
                                @php
                                    ...
                                    $colors = $iconColors[$fileExtension] ?? $iconColors['default'];
                                @endphp
                                <div
                                    class="group relative bg-white border border-gray-200 rounded-xl p-4 hover:border-indigo-300 hover:shadow-lg transition-all duration-200 hover:-translate-y-1 cursor-pointer">
                                    <a href="{{ route('documents.show', $document) }}" class="block">
                                        <!-- File Type Badge -->
                                        <div class="absolute top-3 right-3">
                                            <span
                                                class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium {{ $colors['bg'] }} {{ $colors['text'] }} uppercase tracking-wider">
                                                {{ $fileExtension ?: 'file' }}
                                            </span>
                                        </div>
                                        ...
                                        <!-- Document Icon -->
                                        <div
                                            class="flex items-center justify-center w-16 h-16 {{ $colors['icon'] }} rounded-xl mb-4 group-hover:scale-110 transition-transform">
                                        ...
                                        <div class="space-y-2">
                                            <h4
                                                class="font-semibold text-gray-900 text-sm leading-tight line-clamp-2 group-hover:text-indigo-600 transition-colors">
                                                {{ $document->title }}
                                            </h4>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-100">
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-6 py-5 border-b border-gray-100">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ url('/system-links') }}"
                            class="inline-flex items-center px-3 py-1.5 bg-green-100 hover:bg-green-200 text-green-700 text-sm font-medium rounded-lg transition-colors">
                            <span>See all</span>
                            <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7">
                                </path>
                ...
                <div class="px-6 py-6">
                    ...
                    @else
                        <div class="text-center py-8">
                            <div class="w-12 h-12 mx-auto mb-4 bg-gray-100 rounded-2xl flex items-center justify-center">
                            ...
                            @if (auth()->user()->isAdmin())
                                <a href="{{ route('system-links.create') }}?category=quick_access"
                                    class="inline-flex items-center px-3 py-2 bg-green-500 hover:bg-green-600 text-white text-xs font-medium rounded-lg transition-colors">
                    ...
                    <div class="bg-gradient-to-r from-orange-50 to-red-50 px-6 py-5 border-b border-gray-100">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('news.index') }}"
                                class="inline-flex items-center px-3 py-1.5 bg-orange-100 hover:bg-orange-200 text-orange-700 text-sm font-medium rounded-lg transition-colors">
                                <span>View all</span>
                                <svg class="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 5l7 7-7 7"></path>
                                ...
                                @if ($newsItem instanceof \App\Models\News)
                                    <div class="group relative">
                                        <a href="{{ route('news.show', $newsItem) }}"
                                            class="block p-3 rounded-xl hover:bg-orange-50 transition-colors border border-transparent hover:border-orange-200">
                                            <!-- Priority Badge -->
                                            ...
                                            <div class="space-y-2">
                                                <h4
                                                    class="font-semibold text-gray-900 text-sm leading-tight line-clamp-2 group-hover:text-orange-700 transition-colors {{ $newsItem && is_object($newsItem) && $newsItem->priority && $newsItem->priority === 'high' ? 'pr-20' : '' }}">
                    ...
                    <div class="space-y-4">
                        @if ($canManageContent)
                            <a href="{{ route('announcements.create') }}"
                                class="group w-full flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 rounded-xl transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
                                <div class="flex items-center space-x-3">
                                    <div
                            ...
                            <a href="{{ route('news.create') }}"
                                class="group w-full flex items-center justify-between p-4 bg-gradient-to-r from-teal-50 to-teal-100 hover:from-teal-100 hover:to-teal-200 rounded-xl transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-10 h-10 bg-teal-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z">
                                ...
                                <svg class="w-5 h-5 text-teal-600 group-hover:translate-x-1 transition-transform"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 5l7 7-7 7"></path>
                                </svg>
                            ...
                            <a href="{{ route('polls.create') }}"
                                class="group w-full flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-green-100 hover:from-green-100 hover:to-green-200 rounded-xl transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
                                <div class="flex items-center space-x-3">
                                    <div
                        ...
                        <a href="{{ route('documents.create') }}"
                            class="group w-full flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-purple-100 hover:from-purple-100 hover:to-purple-200 rounded-xl transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
                            <div class="flex items-center space-x-3">
                                <div
                        ...
                        <a href="{{ route('profile.edit') }}"
                            class="group w-full flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-200 rounded-xl transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
                            <div class="flex items-center space-x-3">
                                <div
            ...
            @if ($activePolls->count())
                <div class="bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-100">
                    <div class="bg-gradient-to-r from-green-50 to-teal-50 px-6 py-5 border-b border-gray-100">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <div class="w-8 h-8 bg-green-500 rounded-lg flex items-center justify-center">
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            @foreach ($activePolls as $poll)
                                <div
                                    class="group p-4 rounded-xl hover:bg-green-50 transition-colors cursor-pointer border border-transparent hover:border-green-200">
                                    <a href="{{ route('polls.show', $poll) }}" class="block">
                                        <div class="flex items-start justify-between">
                                            <div class="flex-1 min-w-0">
                                                <p
                                                    class="text-base font-semibold text-gray-900 group-hover:text-green-700 transition-colors mb-2">
                                                    {{ $poll->title }}</p>
                                                <div class="flex items-center space-x-4">
                                                    <div class="flex items-center space-x-2">
                                                        <div class="w-3 h-3 bg-green-400 rounded-full"></div>
                                                        <span
                                                            class="text-sm font-medium text-green-700">{{ ucfirst($poll->type) }}</span>
                                                    </div>
                                                    <span class="text-gray-400">•</span>
                                            ...
                                            <div class="flex-shrink-0 ml-4">
                                                <div
                                                    ...
                                                    <svg class="w-4 h-4 text-green-600 group-hover:translate-x-0.5 transition-transform"
                                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <!-- Centre/Station Admin Specific Sections -->
    @if (auth()->user()->isCentreAdmin() && isset($centreData))
        <div class="mt-8">
            <h2 class="text-lg font-medium text-gray-900 mb-4">{{ $centreData['centreName'] }} Management</h2>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <!-- Centre Users -->
                <div class="bg-white shadow rounded-lg">
                    <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Centre Staff
                            ({{ $centreData['centreUsers']->count() }})</h3>
                    </div>
                    <div class="px-4 py-5 sm:p-6">
                        @if ($centreData['centreUsers']->count())
                            <div class="space-y-2 max-h-64 overflow-y-auto">
                                @foreach ($centreData['centreUsers'] as $user)
                                    <div class="flex items-center space-x-3">
                                        <div class="flex-shrink-0">
                                            <div class="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center">
                                                <span
                                                    class="text-white font-medium text-xs">{{ substr($user->name, 0, 1) }}</span>
                                            </div>
                                        </div>
                                        <div class="min-w-0 flex-1">
                        ...
                        @else
                            <p class="text-sm text-gray-500">No staff assigned to this centre.</p>
                        @endif
                    </div>
                </div>

                <!-- Recent Centre Activity -->
                @if (isset($centreData['recentCentreActivity']) && $centreData['recentCentreActivity']->count())
                    <div class="bg-white shadow rounded-lg">
                        <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">Recent Centre Activity</h3>
                        </div>
                        <div class="px-4 py-5 sm:p-6">
                            <div class="space-y-3 max-h-64 overflow-y-auto">
                                @foreach ($centreData['recentCentreActivity'] as $activity)
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <a href="{{ $activity['url'] }}"
                                                class="block hover:bg-gray-50 rounded p-1 -m-1">
    ...
    <!-- Station Admin Specific Section -->
    @if (auth()->user()->isStationAdmin() && isset($stationData))
        <div class="mt-8">
            <h2 class="text-lg font-medium text-gray-900 mb-4">{{ $stationData['stationName'] }} Management</h2>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <!-- Station Users -->
                <div class="bg-white shadow rounded-lg">
                    <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Station Staff
                            ({{ $stationData['stationUsers']->count() }})</h3>
                        <p class="text-sm text-gray-500">Part of {{ $stationData['stationCentre'] }}</p>
                    </div>
                    <div class="px-4 py-5 sm:p-6">
                        @if ($stationData['stationUsers']->count())
                            <div class="space-y-2 max-h-64 overflow-y-auto">
                                @foreach ($stationData['stationUsers'] as $user)
                                    <div class="flex items-center space-x-3">
                                        <div class="flex-shrink-0">
                                            <div
                                                class="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center">
                        ...
                        @else
                            <p class="text-sm text-gray-500">No staff assigned to this station.</p>
                        @endif
                    </div>
                </div>

                <!-- Recent Station Activity -->
                @if (isset($stationData['recentStationActivity']) && $stationData['recentStationActivity']->count())
                    <div class="bg-white shadow rounded-lg">
                        <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">Recent Station Activity</h3>
                        </div>
                        <div class="px-4 py-5 sm:p-6">
                            <div class="space-y-3 max-h-64 overflow-y-auto">
                                @foreach ($stationData['recentStationActivity'] as $activity)
                                    <div class="flex items-start space-x-3">
                                        <div class="flex-shrink-0">
                                            @if ($activity['type'] === 'announcement')
                                                <div
