...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <!-- Today's Birthdays -->
    <div class="nimr-card group cursor-pointer">
        <div class="relative p-6">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <div class="nimr-icon-birthday">
                ...
                <div class="ml-5 flex-1">
                    ...
                    <div class="flex items-center mt-2">
                        <div class="w-2 h-2 bg-nimr-accent-400 rounded-full animate-pulse mr-2"></div>
        ...
        <div class="nimr-card-footer">
            <a href="#" onclick="showBirthdays()" class="nimr-link">
    ...
    <div class="nimr-card group cursor-pointer">
        <div class="relative p-6">
            <div class="flex items-center">
                ...
                <div class="ml-5 flex-1">
                    ...
                    <div class="flex items-center mt-2">
                        <div class="w-2 h-2 bg-nimr-secondary-400 rounded-full mr-2"></div>
        ...
        <div class="nimr-card-footer">
            <a href="#" onclick="openTodoList()" class="nimr-link">
    ...
    <div class="nimr-card group cursor-pointer">
        <div class="relative p-6">
            <div class="flex items-center">
                ...
                <div class="ml-5 flex-1">
                    ...
                    <div class="flex items-center mt-2">
                        <div class="w-2 h-2 bg-nimr-primary-400 rounded-full mr-2"></div>
        ...
        <div class="nimr-card-footer">
            <a href="#" onclick="openPasswordVault()" class="nimr-link">
    ...
    <div class="nimr-card group cursor-pointer">
        <div class="relative p-6">
            <div class="flex items-center">
                ...
                <div class="ml-5 flex-1">
                    ...
                    <div class="flex items-center mt-2">
                        <div class="w-2 h-2 bg-nimr-accent-400 rounded-full mr-2"></div>
        ...
        <div class="nimr-card-footer">
            <a href="#" onclick="openHelpCenter()" class="nimr-link">
    ...
    <div class="lg:col-span-2 space-y-8">
            ...
            <div class="nimr-card-body">
                @if (isset($recentAnnouncements) && $recentAnnouncements->count())
                    <div class="space-y-4">
                        @foreach ($recentAnnouncements->take(3) as $index => $announcement)
                            <div class="group flex items-start space-x-4 p-4 rounded-xl transition-all duration-200 cursor-pointer border border-gray-100 hover:shadow-md hover:-translate-y-0.5">
                                <div class="flex-shrink-0">
                                    <div class="w-4 h-4 bg-nimr-primary-500 rounded-full mt-1.5 group-hover:scale-125 transition-transform shadow-sm">
                                    </div>
                                </div>
                                <div class="min-w-0 flex-1">
                                    <a href="{{ route('announcements.show', $announcement) }}" class="block">
                                        <p class="text-base font-semibold text-gray-900 group-hover:text-nimr-primary-700 transition-colors line-clamp-2 mb-2">
                                            {{ $announcement->title }}
                                        </p>
                                        <div class="flex items-center space-x-3">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500 max-w-sm mx-auto">When announcements are created, they'll appear here for everyone to see.</p>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div class="nimr-card">
            ...
            <div class="nimr-card-body">
                @if (isset($recentDocuments) && $recentDocuments->count())
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        @foreach ($recentDocuments->take(6) as $index => $document)
                            ...
                            @endphp
                            <div class="group relative bg-white border border-gray-200 rounded-xl p-4 hover:border-nimr-secondary-300 hover:shadow-lg transition-all duration-200 hover:-translate-y-1 cursor-pointer">
                                <a href="{{ route('documents.show', $document) }}" class="block">
                                    ...
                                    <!-- Document Icon -->
                                    <div class="flex items-center justify-center w-16 h-16 nimr-icon-secondary rounded-xl mb-4 group-hover:scale-110 transition-transform">
                                        ...
                                        @elseif(in_array($fileExtension, ['ppt', 'pptx']))
                                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2m0 0v11a2 2 0 01-2 2H9a2 2 0 01-2-2V4m0 0h10M9 9h6m-6 4h6">
                                                </path>
                                            </svg>
                                        @else
                                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <!-- Document Details -->
                                    <div class="space-y-2">
                                        <h4 class="font-semibold text-gray-900 text-sm leading-tight line-clamp-2 group-hover:text-nimr-secondary-700 transition-colors">
                                            {{ $document->title }}
                                        </h4>
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="text-xs text-gray-600 truncate">{{ $document->uploader->name }}</span>
                                        </div>
                                        @endif
                                    </div>
                                    <!-- Download Indicator -->
                                    <div class="absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <div class="w-6 h-6 bg-nimr-secondary-500 rounded-full flex items-center justify-center">
                ...
                @else
                    <div class="text-center py-12">
                        <div class="w-20 h-20 bg-nimr-secondary-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <svg class="w-10 h-10 text-nimr-secondary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                                </path>
                            </svg>
                        </div>
                        <h3 class="text-lg font-medium text-gray-900 mb-2">No documents available</h3>
                        <p class="text-gray-500 max-w-sm mx-auto mb-4">Upload documents to share files and resources with your team.</p>
            ...
            <div class="nimr-card-body">
                @if (isset($quickAccessLinks) && $quickAccessLinks->count() > 0)
                    <div class="space-y-3">
                        @foreach ($quickAccessLinks as $link)
                            <a href="{{ $link->url }}" target="{{ $link->opens_new_tab ? '_blank' : '_self' }}" class="group flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 bg-nimr-secondary-100 rounded-lg flex items-center justify-center">
                ...
                @else
                    <div class="text-center py-8">
                        <div class="w-12 h-12 mx-auto mb-4 bg-nimr-secondary-100 rounded-2xl flex items-center justify-center">
                            <svg class="w-6 h-6 text-nimr-secondary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1">
                                </path>
                            </svg>
                        </div>
                        ...
                        <a href="{{ route('system-links.create') }}?category=quick_access" class="nimr-btn-secondary-sm">
            ...
            <div class="nimr-card-body">
                <div class="space-y-4">
                    ...
                    <div class="group relative">
                        <a href="{{ route('news.show', $newsItem) }}" class="block p-3 rounded-xl hover:bg-nimr-accent-50 transition-colors border border-transparent hover:border-nimr-accent-200">
                            <!-- Priority Badge -->
                            ...
                            <div class="w-full h-24 bg-gray-200 rounded-lg mb-3 overflow-hidden">
                                <img src="{{ $newsItem && is_object($newsItem) ? $newsItem->featured_image_url : asset('images/default-news.jpg') }}" alt="{{ $newsItem && is_object($newsItem) ? $newsItem->title : 'News Article' }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-200">
                            </div>
                            @endif

                            <!-- News Content -->
                            <div class="space-y-2">
                                <h4 class="font-semibold text-gray-900 text-sm leading-tight line-clamp-2 group-hover:text-nimr-accent-700 transition-colors {{ $newsItem && is_object($newsItem) && $newsItem->priority && $newsItem->priority === 'high' ? 'pr-20' : '' }}">
                                ...
                                <div class="flex items-center justify-between text-xs text-gray-500">
                                    <div class="flex items-center space-x-2">
                                        <span class="font-medium">{{ $newsItem && is_object($newsItem) ? $newsItem->location_display : 'Unknown Location' }}</span>
            ...
            <div class="nimr-card-body">
                <div class="space-y-4">
                    ...
                    <a href="{{ route('announcements.create') }}" class="nimr-action-card nimr-action-primary">
                        ...
                        <svg class="w-5 h-5 text-nimr-primary-600 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                    </a>
                    <a href="{{ route('news.create') }}" class="nimr-action-card nimr-action-secondary">
                        ...
                        <svg class="w-5 h-5 text-nimr-secondary-600 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                    </a>
                    <a href="{{ route('polls.create') }}" class="nimr-action-card nimr-action-accent">
                        ...
                        <svg class="w-5 h-5 text-nimr-accent-600 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
                    </a>
                    @endif
        ...
        <div class="nimr-card">
            ...
            <div class="nimr-card-body">
                <div class="space-y-4">
                    ...
                    <div class="group p-4 rounded-xl hover:bg-nimr-secondary-50 transition-colors cursor-pointer border border-transparent hover:border-nimr-secondary-200">
                        <a href="{{ route('polls.show', $poll) }}" class="block">
                            <div class="flex items-start justify-between">
                                <div class="flex-1 min-w-0">
                                    <p class="text-base font-semibold text-gray-900 group-hover:text-nimr-secondary-700 transition-colors mb-2">
                                        {{ $poll->title }}
                                    </p>
                                    <div class="flex items-center space-x-4">
                                        <div class="flex items-center space-x-2">
                                            <div class="w-3 h-3 bg-nimr-secondary-400 rounded-full"></div>
                                            <span class="text-sm font-medium text-nimr-secondary-700">{{ ucfirst($poll->type) }}</span>
                                        </div>
                                        <span class="text-gray-400">•</span>
                                        <span class="text-sm text-gray-600">{{ $poll->responses()->count() }} responses</span>
                                    </div>
                                </div>
                                <div class="flex-shrink-0 ml-4">
                                    <div class="w-8 h-8 bg-nimr-secondary-100 rounded-lg flex items-center justify-center group-hover:bg-nimr-secondary-200 transition-colors">
                                        <svg class="w-4 h-4 text-nimr-secondary-600 group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                        </svg>
                                    </div>
                                </div>
